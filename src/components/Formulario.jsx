...
const Formulario = ({setMonedas}) => {
    ...
    const[criptomoneda, SelectCriptomonedas] = useSelectMonedas('Selecciona tu Criptomoneda', cripto)
 //Cuando se aplica destructuring retorna por el indice del array
